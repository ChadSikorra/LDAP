...
final class SyncRefreshPresentTest extends TestCase
{
    private SyncRefreshPresent $subject;
    ...
    public function test_it_should_get_whether_the_refresh_is_done(): void
    {
        self::assertFalse($this->subject->getRefreshDone());
    }
    ...
    public function test_it_should_be_constructed_from_ASN1(): void
    {
        ...
        self::assertEquals(
            new SyncRefreshPresent(false, 'omnomnom'),
            SyncRefreshPresent::fromAsn1(Asn1::application(25, Asn1::sequence(
