...
final class SyncRefreshDeleteTest extends TestCase
{
    private SyncRefreshDelete $subject;
    ...
    public function test_it_should_be_constructed_from_ASN1(): void
    {
        ...
        self::assertEquals(
            new SyncRefreshDelete(false, 'omnomnom'),
            SyncRefreshDelete::fromAsn1(Asn1::application(25, Asn1::sequence(
